...
const ListTransactions = () => {
  ...
  const data = [
    {id: '5', date: '26/02/2020', desc: 'Netflix', value: 34.90, input: false},
    {id: '4', date: '26/02/2020', desc: 'Internet', value: 34.90, input: false},
    {id: '3', date: '25/02/2020', desc: 'Video Game', value: 34.90, input: true},
    {id: '2', date: '24/02/2020', desc: 'Aluguel', value: 34.90, input: false},
    {id: '1', date: '24/02/2020', desc: 'Salário', value: 34.90, input: true}
  ]
